            ...
            <div class="col-md-8">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-header bg-white">
                        <h5 class="mb-0">
                            <i class="ti ti-user-edit me-1"></i> Edit Profil
                        </h5>
                    </div>
                    <div class="card-body">
                        <form wire:submit.prevent="update">
                            ...
                            {{-- PASSWORD LAMA (WAJIB UNTUK VERIFIKASI) --}}
                            <div class="mb-3">
...
<script>
    ...
    $wire.on('tampilKonfirmasiGantiPassword', () => {
        Swal.fire({
            ...
            confirmButtonText: '<i class="ti ti-key me-1"></i> Ya, Ganti!',
            cancelButtonText: '<i class="ti ti-x me-1"></i> Batal',
            reverseButtons: true
        }).then((result) => {
            if (result.isConfirmed) {
                $wire.dispatch('prosesGantiPassword');
            }
        });
    });
</script>
